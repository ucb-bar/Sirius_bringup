...
module TLSourceAdjuster(
  ...
  input  [9:0]  auto_in_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25]
  ...
  output [9:0]  auto_in_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25]
  ...
  assign auto_in_d_bits_source = {{2{auto_out_d_bits_source[7]}}, auto_out_d_bits_source} - 10'h200;	// @[generators/testchipip/src/main/scala/serdes/SourceAdjuster.scala:50:23]
  ...
  assign auto_out_a_bits_source = auto_in_a_bits_source[7:0];	// @[generators/testchipip/src/main/scala/serdes/SourceAdjuster.scala:44:22]
