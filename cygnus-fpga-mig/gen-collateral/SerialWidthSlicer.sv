...
module SerialWidthSlicer(
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      if (&wide_beats)	// @[generators/testchipip/src/main/scala/serdes/Adapter.scala:39:27, :40:35]
        wide_beats <= 2'h0;	// @[generators/testchipip/src/main/scala/serdes/Adapter.scala:39:27]
      else	// @[generators/testchipip/src/main/scala/serdes/Adapter.scala:40:35]
        wide_beats <= wide_beats + 2'h1;	// @[generators/testchipip/src/main/scala/serdes/Adapter.scala:39:27, :45:55]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        wide_beats = _RANDOM[/*Zero width*/ 1'b0][1:0];	// @[generators/testchipip/src/main/scala/serdes/Adapter.scala:39:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_wide_ready = (&wide_beats) & io_narrow_ready;	// @[generators/testchipip/src/main/scala/serdes/Adapter.scala:39:27, :40:35, :47:35]
  assign io_narrow_valid = io_wide_valid;
  assign io_narrow_bits = _GEN[wide_beats];	// @[generators/testchipip/src/main/scala/serdes/Adapter.scala:39:27, :43:18]
endmodule
