...
module TLBuffer_NexysVideoHarness_UNIQUIFIED(
  input         clock,
  input         reset,
  ...
  output [3:0]  auto_out_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25]
  ...
  input  [3:0]  auto_out_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25]
