...
module GenericSerializer_3(
  ...
  wire             _GEN_1 = io_out_ready & (|beat);	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:21, :22:39, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  always @(posedge clock) begin
    if (_GEN_1 & _io_out_bits_flit_T) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17, :21:39, :25:22, :27:25, :28:12, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      data_1 <= 16'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17]
      data_2 <= 16'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17]
      data_3 <= 16'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17]
      data_4 <= 16'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17]
      data_5 <= 16'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17]
    end
    if (reset)
  ...
  assign io_out_valid = |beat;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:21, :22:39]
  assign io_out_bits_flit = _io_out_bits_flit_T ? {14'h0, io_in_bits_head, io_in_bits_tail} : _GEN_0[beat];	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:21, :21:39, :23:{26,52}]
endmodule
