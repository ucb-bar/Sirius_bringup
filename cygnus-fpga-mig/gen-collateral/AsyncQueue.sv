...
module AsyncQueue(
  ...
  input  io_enq_reset,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
  ...
  input  io_enq_bits_phit,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
  input  io_deq_clock,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
  input  io_deq_reset,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
  input  io_deq_ready,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
  output io_deq_valid,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
  output io_deq_bits_phit	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
);
  ...
  wire       _source_io_async_mem_0_phit;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire       _source_io_async_mem_1_phit;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire       _source_io_async_mem_2_phit;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire       _source_io_async_mem_3_phit;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire       _source_io_async_mem_4_phit;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire       _source_io_async_mem_5_phit;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire       _source_io_async_mem_6_phit;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire       _source_io_async_mem_7_phit;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  ...
  );	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  AsyncQueueSink_5 sink (	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:225:70]
    ...
    .io_async_mem_0_phit          (_source_io_async_mem_0_phit),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .io_async_mem_1_phit          (_source_io_async_mem_1_phit),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .io_async_mem_2_phit          (_source_io_async_mem_2_phit),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .io_async_mem_3_phit          (_source_io_async_mem_3_phit),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .io_async_mem_4_phit          (_source_io_async_mem_4_phit),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .io_async_mem_5_phit          (_source_io_async_mem_5_phit),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .io_async_mem_6_phit          (_source_io_async_mem_6_phit),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .io_async_mem_7_phit          (_source_io_async_mem_7_phit),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  ...
  );	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:225:70]
endmodule
