...
module UARTRx(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valid <= state & _GEN_2 & data_last;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:71:31, :108:22, :109:9, :114:22, :116:18, :138:20, :144:27, :159:30]
    end
    if (_GEN_0)	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:114:22, :116:18, :122:21, :124:29, :125:17]
      prescaler <= (restore ? 13'h1B : prescaler) - {12'h0, ~(restore & sample_count < 4'h2)};	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:63:22, :73:25, :88:25, :89:30, :98:23, :99:25, :100:{37,42,51}]
    ...
    if (state & _GEN_1)	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:102:19, :114:22, :116:18, :138:20, :140:16]
