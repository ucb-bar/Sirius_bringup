...
module GenericSerializer_1(
  ...
  input  [64:0] io_in_bits_payload,	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:9:14]
  ...
  wire [2:0][15:0] _GEN = '{16'h0, 16'h0, 16'h0};
  ...
  wire [7:0][15:0] _GEN_0 = {_GEN, {{data_4}, {data_3}, {data_2}, {data_1}, {16'h0}}};	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17, :23:26]
  ...
  always @(posedge clock) begin
    if (_GEN_1 & _io_out_bits_flit_T) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17, :21:39, :25:22, :27:25, :28:12, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ...
      data_4 <= {13'h0, io_in_bits_payload[64:62]};	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17, :28:34]
    end
    if (reset)
      ...
      if (beat == 3'h4)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:21, :26:22]
        beat <= 3'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:21]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beat = _RANDOM[2'h2][18:16];	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:18:17, :19:21]
      `endif // RANDOMIZE_REG_INIT
    end // initial
