...
module Queue_20(
  ...
  input  [3:0] io_enq_bits_tl_state_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [3:0] io_deq_bits_tl_state_source	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);
