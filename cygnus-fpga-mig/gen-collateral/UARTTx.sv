...
module UARTTx(
  ...
  wire        _GEN = ~(|counter) & io_in_valid;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTTx.scala:57:24, :65:23, :66:27, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  `ifndef SYNTHESIS	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTTx.scala:69:11]
    always @(posedge clock) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTTx.scala:69:11]
      if ((`PRINTF_COND_) & _GEN & (|_plusarg_reader_1_out) & ~reset)	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTTx.scala:63:85, :68:20, :69:11, generators/rocket-chip/src/main/scala/util/PlusArg.scala:80:11, src/main/scala/chisel3/util/Decoupled.scala:52:35]
    ...
    if (reset) begin
      ...
      if (|counter) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTTx.scala:57:24, :65:23]
        if (pulse)	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTTx.scala:53:26]
          prescaler <= 16'h1B2;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTTx.scala:52:26]
  ...
  assign io_in_ready = ~(|counter);	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTTx.scala:57:24, :65:23, :66:27]
