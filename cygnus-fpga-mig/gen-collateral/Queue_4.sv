...
module Queue_4(
  ...
  ram_8x79 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_last, io_enq_bits_echo_tl_state_source, io_enq_bits_echo_tl_state_size, io_enq_bits_resp, io_enq_bits_data, io_enq_bits_id})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_echo_tl_state_source = _ram_ext_R0_data[77:74];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_last = _ram_ext_R0_data[78];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
