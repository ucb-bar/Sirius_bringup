...
module TLAToBeat(
  ...
  input  [2:0]  io_protocol_bits_param,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:39:14]
  ...
  input  [63:0] io_protocol_bits_address,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:39:14]
  input  [7:0]  io_protocol_bits_mask,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:39:14]
  ...
  output [85:0] io_beat_bits_payload,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:39:14]
  ...
  wire         has_body;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:45]
  ...
  wire [2:0]   _q_io_deq_bits_param;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:46:17]
  ...
  wire [63:0]  _q_io_deq_bits_address;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:46:17]
  wire [7:0]   _q_io_deq_bits_mask;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:46:17]
  ...
  wire [2:0]   tail_beats1 = _q_io_deq_bits_opcode[2] ? 3'h0 : ~(_tail_beats1_decode_T_1[5:3]);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:46:17]
  ...
  wire         q_io_deq_ready = io_beat_ready & (is_body | ~has_body);	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:59:24, :61:{35,47,50}, :108:45]
  ...
  wire         io_beat_bits_tail_0 = (tail_counter == 3'h1 | tail_beats1 == 3'h0) & (is_body | ~has_body);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:59:24, :61:50, :64:{35,47}, :108:45]
  assign has_body = ~(_q_io_deq_bits_opcode[2]) | _q_io_deq_bits_mask != 8'hFF;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:{28,37}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:46:17, :108:{45,69}]
    ...
    if (reset) begin
      ...
      if (q_io_deq_ready & _q_io_deq_valid) begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:46:17, :61:35, src/main/scala/chisel3/util/Decoupled.scala:52:35]
        if (head)	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25]
          head_counter <= _q_io_deq_bits_opcode[2] ? 3'h0 : ~(_head_beats1_decode_T_1[5:3]);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, :229:27, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:46:17]
  ...
  Queue_68 q (	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:46:17]
    .clock               (clock),
    .reset               (reset),
