...
module AsyncQueueSink_4(
  ...
  assign io_deq_bits_id = _io_deq_bits_deq_bits_reg_io_q[5:2];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_resp = _io_deq_bits_deq_bits_reg_io_q[1:0];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
