...
HD_PWD='/bwrcq/C/vikramj/Cygnus-Bringup/cygnus-fpga-mig/NexysVideoHarness.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NexysVideoHarness.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NexysVideoHarness.tcl
