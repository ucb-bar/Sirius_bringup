...
HD_PWD='/bwrcq/C/vikramj/Cygnus-Bringup/cygnus-fpga-mig/NexysVideoHarness.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NexysVideoHarness.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NexysVideoHarness.tcl -notrace
